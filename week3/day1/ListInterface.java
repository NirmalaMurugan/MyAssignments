...
public class ListInterface {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// ------------------------
		//label[contains(text()='Fashion Bags')]/preceding-sibling::input[@type='checkbox']
		WebElement fashionbags = driver.findElement(By.xpath("//label[contains(text()='Fashion Bags')]/preceding-sibling::input[@type='checkbox']"));
		fashionbags.click();
		System.out.println("Fbags is clicked");
